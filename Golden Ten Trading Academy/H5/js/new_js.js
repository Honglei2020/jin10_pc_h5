window.onload =  function(){
    ...
    function fn(data){  
        for(var i=0;i<3;i++){
            ...
            c_vdeio[index].src =  data[index].course_img 
            c_number[index].src =  data[index].course_number_img 
            v_left[index].src =  data[index].v_img1
            v_right[index].src = data[index].v_img2
    ...
    var addwechat = document.querySelector(".addwechat");
    var showerweima = document.querySelector(".showerweima");
    addwechat.onclick = function(){
        console.log("asd");
        showerweima.style.display = "block";
    }
    var closeerweima = document.querySelector(".close");
    closeerweima.onclick=function(){
        showerweima.style.display = "none";
    }
}